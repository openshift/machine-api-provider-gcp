description
Bump Kubernetes and Go to new minor versions across the project. Use when upgrading k8s (e.g. from 1.35 to 1.36) and Go (e.g. from 1.25 to 1.26). Handles go.mod, Makefile, Dockerfiles, .ci-operator.yaml, AGENTS.md, and vendoring.
