...
unit: # Run unit test
	...
	KUBEBUILDER_ASSETS="$(shell $(ENVTEST) use $(ENVTEST_K8S_VERSION) -p path --bin-dir $(PROJECT_DIR)/bin --use-deprecated-gcs=true --remote-bucket openshift-kubebuilder-tools)" ./hack/test.sh
