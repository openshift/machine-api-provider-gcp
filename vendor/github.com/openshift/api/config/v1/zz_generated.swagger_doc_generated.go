...
var map_GCPPlatformStatus = map[string]string{
	...
	"organizationID": "OrganizationID is the Organization ID the new GCP resources created for the cluster. belongs to.",
...
var map_GCPResourceLabel = map[string]string{
	...
	"key":   "key is the key part of the label. A label key can have a maximum of 63 characters and cannot be empty. Label must begin with a lowercase letter, and must contain only lowercase letters, numeric characters, and the following special characters `_ -`.",
